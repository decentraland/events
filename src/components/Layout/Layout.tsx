    ...
    <>
      ...
      >
        {connection
          ...
          .filter((providerType) =>
            [ProviderType.INJECTED, ProviderType.FORTMATIC].includes(
              providerType
            )
          )
          .map((providerType) => {
            switch (providerType) {
              case ProviderType.INJECTED:
                return (
                  <LoginModal.Option
                    key={ProviderType.INJECTED}
                    type={LoginModalOptionType.METAMASK}
                    onClick={() =>
                      actions.connect(providerType, ChainId.ETHEREUM_MAINNET)
                    }
                  />
                )
