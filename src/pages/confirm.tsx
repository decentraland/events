  ...
  return (
    <>
      ...
      <Container className="SettingsPage">
        {verify === ok && <div style={{ textAlign: 'center' }}>
          <Divider />
          <Paragraph secondary>Your email was verified</Paragraph>
          <Divider />
        </div>}
        {unsubscribe === ok && <div style={{ textAlign: 'center' }}>
          <Divider />
          <Paragraph secondary>Your subscription was canceled</Paragraph>
          <Divider />
        </div>}
        {(verify === expired || unsubscribe === expired) && <div style={{ textAlign: 'center' }}>
          <Divider />
          <Paragraph secondary>Invalid token</Paragraph>
          <Divider />
        </div>}
        {(verify === invalid || unsubscribe === invalid) && <div style={{ textAlign: 'center' }}>
          <Divider />
