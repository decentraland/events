...
import { canEditAnyEvent } from "events-web/src/entities/ProfileSettings/utils"
import locations from "events-web/src/modules/locations"
import { places } from "events-web/src/modules/places"
import placesLocations from "events-web/src/modules/placesLocations"
      ...
      {props.showAttendees !== false && (
        <EventSection>
          ...
          <EventSection.Action>
            {attendeesDiff > 0 && (
              <div
                className="event-detail__detail-show-attendees"
