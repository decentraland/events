...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.alterColumn(EventModel.tableName, 'recurrent_until', { type: 'TIMESTAMPTZ' })
  pgm.alterColumn(EventModel.tableName, 'recurrent_dates', { type: 'TIMESTAMPTZ[]' })

  pgm.alterColumn(EventAttendeeModel.tableName, 'created_at', { type: 'TIMESTAMPTZ' })
}
